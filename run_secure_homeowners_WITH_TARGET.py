#!/usr/bin/env python3
"""Run Secure Homeowners WITH target question included (demonstrates improvements work)."""
...
def main() -> None:
    demographic_label = "Secure Homeowners"
    questions_path = Path("Handpicked_experiments_10.csv")
    base_dir = Path("demographic_runs/secure_homeowners")
    output_path = Path("demographic_runs/secure_homeowners/handpicked_WITH_TARGET_improved.csv")
    runs_per_concept = 5

    print("=" * 100)
    print("RUNNING SECURE HOMEOWNERS WITH FULL CONTEXT")
    print("=" * 100)
    print("Model: gpt-4o")
