#!/usr/bin/env python3
"""Run Starting Out WITH target question included (demonstrates improvements work)."""
...
def main() -> None:
    demographic_label = "Starting Out"
    questions_path = Path("Handpicked_experiments_10.csv")
    base_dir = Path("demographic_runs/starting_out")
    output_path = Path("demographic_runs/starting_out/handpicked_WITH_TARGET_improved.csv")
    runs_per_concept = 5

    print("=" * 100)
    print("RUNNING STARTING OUT WITH FULL CONTEXT")
    print("=" * 100)
    print("Model: gpt-4o")
